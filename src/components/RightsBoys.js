    ...
    <BoyDialogContainer>
      <DialogueContainer>
        <DialogueText className={showText ? 'show' : ''}>
          Hello, I am Doraemon. I came flying from so long 
          <br />
          to let you know your rights. 
        </DialogueText>
      </DialogueContainer>
      <BoyGifContainer>
        <BoyGif src="Dorfly.gif" alt="Boy" />
      </BoyGifContainer>
    </BoyDialogContainer>
  );
};

export default BoyDialogComponentDor;
