    ...
    <BoyDialogContainer>
      <DialogueContainer>
        <DialogueText className={showText ? 'show' : ''}>
          Oggy here!! Look how I am dancing. This
          <br />
          is because I am so excited to have you in Sashakt.
          <br/>
          Click on "Continue Adventure " to signin or
          <br/>
          "Start Adventure " to signup
        </DialogueText>
      </DialogueContainer>
      <BoyGifContainer>
        <BoyGif src="oggydance.gif" alt="Boy" />
      </BoyGifContainer>
    </BoyDialogContainer>
  );
};

export default BoyDialogComponentoggy;
