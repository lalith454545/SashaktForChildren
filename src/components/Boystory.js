...
const BoyDialogComponentpikachu = () => {
    ...
    <BoyDialogContainer>
      <DialogueContainer>
        <DialogueText className={showText ? 'show' : ''}>
          I am Pikachu !! So excited to show you my child right videos
          <br />
          Click on any video to start learning.
        </DialogueText>
      </DialogueContainer>
      <BoyGifContainer>
        <BoyGif src="pikachu.gif" alt="Boy" />
      </BoyGifContainer>
    </BoyDialogContainer>
  );
};

export default BoyDialogComponentpikachu;
