    ...
    <BoyDialogContainer>
      <DialogueContainer>
        <DialogueText className={showText ? 'show' : ''}>
          Hello! This is your friend Shinchan.
          <br />
          Now click on the box to start learning.
        </DialogueText>
      </DialogueContainer>
      <BoyGifContainer>
        <BoyGif src="shinhi2.gif" alt="Boy" />
      </BoyGifContainer>
    </BoyDialogContainer>
  );
};

export default BoyDialogComponent;
